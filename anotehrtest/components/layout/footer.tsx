  ...
  return (
    <footer className="border-t border-border bg-primary text-primary-foreground">
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:py-10 lg:py-14 sm:px-6 lg:px-8">
        <div className="grid gap-6 sm:gap-8 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            <Link href="/" className="flex items-center gap-2">
              <div className="flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg bg-secondary">
                <Factory className="h-4 w-4 sm:h-5 sm:w-5 text-secondary-foreground" />
              </div>
              <span className="font-serif text-base sm:text-lg lg:text-xl font-medium">SourceNest</span>
            </Link>
            <p className="mt-3 sm:mt-4 max-w-xs text-xs sm:text-sm leading-relaxed text-primary-foreground/80">
          ...
          {/* Link Columns */}
          <div>
            <h3 className="text-xs sm:text-sm font-semibold">{footerLinks.platform.title}</h3>
            <ul className="mt-2.5 sm:mt-4 space-y-2 sm:space-y-3">
              {footerLinks.platform.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-xs sm:text-sm text-primary-foreground/70 transition-colors hover:text-primary-foreground"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-semibold">{footerLinks.discover.title}</h3>
            <ul className="mt-2.5 sm:mt-4 space-y-2 sm:space-y-3">
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-semibold">{footerLinks.resources.title}</h3>
            <ul className="mt-2.5 sm:mt-4 space-y-2 sm:space-y-3">
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-semibold">{footerLinks.company.title}</h3>
            <ul className="mt-2.5 sm:mt-4 space-y-2 sm:space-y-3">
        ...
        {/* Industries Row */}
        <div className="mt-8 sm:mt-10 lg:mt-12 border-t border-primary-foreground/10 pt-6 sm:pt-8">
          <h3 className="text-xs sm:text-sm font-semibold">Popular Industries</h3>
          <div className="mt-3 sm:mt-4 flex flex-wrap gap-x-4 sm:gap-x-6 gap-y-1.5 sm:gap-y-2">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 sm:gap-4 px-4 py-4 sm:py-6 sm:flex-row sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 sm:gap-x-6 gap-y-1.5 sm:gap-y-2">
            {footerLinks.legal.links.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-xs sm:text-sm text-primary-foreground/60 transition-colors hover:text-primary-foreground"
              >
                {link.label}
              </Link>
            ))}
