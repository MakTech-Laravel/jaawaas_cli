...
const navigation = [
  ...
  { name: "Orders", href: "/dashboard/manufacturer/orders", icon: PackageCheck },
  ...
  { name: "Support", href: "/dashboard/manufacturer/support", icon: LifeBuoy },
        ...
        <header className="flex h-16 items-center justify-between border-b border-border bg-card px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3">
            <Button variant="outline" size="sm" className="hidden gap-1.5 bg-transparent sm:inline-flex" asChild>
              <Link href="/dashboard/manufacturer/support">
