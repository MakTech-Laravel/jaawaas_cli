...
const he: TranslationKeys = {
  ...
  landing: {
    ...
    howItWorks: {
      ...
      mfgStep2Desc: "הירשם לתוכנית שבחרת באמצעות תשלום מאובטח. חשבונך נוצר אך דורש אישור לפני פתיחתו לרוכשים.",
      ...
      mfgStep5Desc: "לאחר מכן הגש את הפרופיל שלך לצוות שלנו לבדיקה. אנו מעריכים את המידע שהוגש כדי לשמור על איכות הפלטפורמה.",
    ...
    featured: {
      ...
      industriesTitle: "תעשיות מבוקשות",
      industriesSubtitle: "מצא יצרנים מתמחים ברחבי מגזרי ייצור מרכזיים"
    },
    trust: {
