...
const he = {
  ...
  nav: {
    ...
    twoFactorCodeRequiredDesc: "הזן את קוד האימות מאפליקציית האימות שלך.",
    twoFactorSetupError: "לא ניתן היה להתחיל בהגדרת אימות דו-שלבי",
    twoFactorVerifyError: "לא ניתן היה לאמת את הקוד",
    twoFactorDisableError: "לא ניתן היה להשבית אימות דו-שלבי",
    twoFactorLoadCodesError: "לא ניתן היה לטעון קודי שחזור",
    twoFactorRegenerateError: "לא ניתן היה ליצור קודים מחדש",
