...
const he = {
  ...
  nav: {
    ...
    statusSuspended: "החשבון מושעה",
    statusNeedsMoreInfo: "נדרש מידע נוסף",
    descPendingApproval: "החשבון שלך נמצא בבדיקה.",
    descRejected: "אנא פנה לתמיכה.",
    descSuspended: "אנא פנה לתמיכה.",
    descNeedsMoreInfo: "בדוק את ההודעות שלך.",
    requiredBadge: "נדרש",
    loading: "טוען…",
    ...
    adminReviewManagement: "ניהול ביקורות",
    adminHelpCenter: "מרכז עזרה",
    adminSettings: "הגדרות",
    adminViewSite: "צפה באתר",
    adminSignOut: "התנתקות",
    adminOrders: "הזמנות",
    adminSupportTickets: "קריאות שירות",
  },
  settings: {
    title: "הגדרות",
    ...
    twoFactorEnabledDesc: "מופעל. השתמש באפליקציית האימות שלך במהלך ההתחברות.",
    twoFactorDisabledDesc: "הוסף שכבת אבטחה נוספת לחשבون שלך.",
    twoFactorViewRecoveryCodes: "הצג קודי שחזור",
    twoFactorRegenerateCodes: "צור קודים מחדش",
    twoFactorEnableTitle: "הפעל אימות דו-שלבי",
    twoFactorEnableDesc: "הזן את סיסמת החשבون שלך כדי להתחיל בהגדרת אימות דו-שלבי.",
    twoFactorStartSetup: "התחל בהגדרה",
    twoFactorScanAndVerify: "סרוק ואמת",
    twoFactorManualKey: "מפתח ידני:",
    twoFactorVerificationCode: "קוד אימות",
    twoFactorConfirmAndEnable: "אשר והפעל",
    twoFactorDisableTitle: "השבת אימות דו-שלבי",
    twoFactorDisableBtn: "השבת",
    twoFactorRegenerateBtn: "צור מחדש",
    twoFactorDisableDesc: "הזن את הסיסמה שלך כדי להסיר את הגנת האימות הדו-שלבי.",
    twoFactorRecoveryCodesTitle: "קודי שحזור",
    twoFactorCopyCodes: "העתק קודים",
    twoFactorDone: "בוצע",
    twoFactorRegenerateTitle: "צור קודי שحזור מחדש",
    twoFactorRegenerateDesc: "קודי השחזור הנוכחיים שלך יפסיקו לפעול באופן מיידי.",
    twoFactorPasswordRequired: "נדרשת סיסמה",
    twoFactorPasswordRequiredEnableDesc: "אנא הזן את הסיסמה שלך כדי להפעיל אימות דו-שלבי.",
    twoFactorPasswordRequiredDisableDesc: "אנא הזן את הסיסמה שלך כדי להשבית אימות דו-שלבי.",
    twoFactorPasswordRequiredRegenDesc: "אנא הזן את הסיסמה שלך כדי ליצור קודי שחזור מחדש.",
    twoFactorCodeRequired: "נדרש קוד",
    twoFactorCodeRequiredDesc: "הזن את קוד האימות מאפליקציית האימות שלך.",
    twoFactorEnabledToast: "אימות דו-שלבי הופעל",
    twoFactorEnabledToastDesc: "שמור את קודי השחזור שלך במקום בטוח.",
    twoFactorDisabledToast: "אימות דו-שלבי הושבת",
    twoFactorDisabledToastDesc: "החשבון שלך משתמש כעת בכניסה באמצעות סיסמה בלبد.",
    twoFactorRegeneratedToast: "קודי שحזור נוצרו מחדش",
    twoFactorRegeneratedToastDesc: "קודי השחזור הישנים שלך אינם תקפים יותר.",
    twoFactorCopiedToast: "הועתק",
    twoFactorCopiedToastDesc: "קודי השחזור הועתקו ללוח.",
    twoFactorCopyFailedToast: "ההעתקה נכשלה",
    twoFactorCopyFailedToastDesc: "אנא העתק את קודי השحזור באופן ידני.",
    twoFactorStarting: "מתחיל...",
    twoFactorVerifying: "מאמת...",
    twoFactorDisabling: "משבית...",
    twoFactorRegenerating: "יוצר מחדش...",
    twoFactorNoRecoveryCodes: "אין עדיין קודי שחזור זמינים.",
    twoFactorDefaultSetupMessage: "סרוק את קוד ה-QR הזה באמצעות אפליקציית האימות שלך והזן את הקود בן 6 הספרות.",
    twoFactorDefaultRecoveryMessage: "שמור את קודי הגיבוי הללו במקום בטוח. ניתן להשתמש בכל קוד פעם אחת בלבד.",
    ...
    failedToLoadSettings: "טעינת ההגדרות נכשלה.",
    settingsSavedSuccess: "ההגדרות נשמרו בהצלחה.",
    failedToSaveSettings: "שמירת ההגדרות נכשלה.",
    backupQueuedSuccess: "הגיבוי נקבע בהצלחה.",
    failedToQueueBackup: "קביעת הגיבוי נכשלה.",
    failedToLoadTables: "טעינת הטבלאות נכשלה.",
    selectAtLeastOneTable: "בחר לפחות טבלה אחת לייצוא.",
    exportQueuedSuccess: "הייצוא נקבע בהצלחה.",
    failedToQueueExport: "קביעת הייצוא נכשלה.",
    downloadFailed: "ההורדה נכשלה.",
    noBackupsYet: "אין גיבויים עדיין",
    recentExports: "ייצואים אחרונים",
    exportFullDatabase: "מסד נתונים מלא",
    exportSelectTables: "בחר טבלאות",
    ...
    deactivateDesc: "השבת את חשבונך באופן זמני. תוכל להפעיל אותו מחדש מאוחר יותר באמצעות הסיסמה שלך.",
    reactivateAccount: "הפעל מחדש את החשבון",
    reactivateDesc: "אם השבתת בעבר, הזן את הסיסמה שלך כדי להפעיל מחדש את החשבון.",
    deleteDesc: "בקש מחיקה לצמיתות. ייתכן שתצטרך לאשר באמצעות דוא\"ל או OTP לאחר מכן.",
    startedDeletionMistake: "התחלת מחיקה בטעות?",
    restoreAccount: "שחזר חשבון",
    confirmDeactivation: "אשר השבתה",
    confirmPassword: "אשר את הסיסמה שלך. תנותק מהמערכת עד שתפעיל מחדש.",
    deactivating: "משבית…",
    reactivating: "מפעיל מחדש…",
    submitting: "שולח…",
    submitDeletionRequest: "שלח בקשת מחיקה",
    deleteRequestDesc: "פעולה זו מתחילה את תהליך המחיקה בשרת. לא ניתן לבטל פעולה זו מכאן לאחר השלמתה.",
    reasonOptional: "סיבה (אופציונלי)",
    reasonRequired: "סיבה",
    passwordLabel: "סיסמה",
    reasonPlaceholder: "ספר לנו מדוע אתה עוזב (אופציונלי אך מועיל)",
    enterPasswordToRestore: "הזן את הסיסמה הנוכחית שלך כדי לשחזר גישה מלאה.",
    deactivateBtn: "השבת",
  ...
  landing: {
    ...
    suppliersMap: {
      ...
      searchRegionsTitle: "אזורים תואמים",
      searchCountriesTitle: "מדינות תואמות",
      searchNoResults: "החיפוש שלך לא נמצא",
      searchNoResultsHint: "לא מצאנו מדינות או אזורים התואמים לחיפוש שלך. נסה מונח אחר, עיין בשאלות נפוצות או צור קשר עם התמיכה.",
      searchViewFaq: "צפה בשאלות נפוצות",
      searchContactSupport: "צור קשר עם התמיכה",
    },
    whyUse: {
  ...
  pricing: {
    ...
    faq: {
      ...
      a1: "כן. לאחר שפרופיל היצרן שלך ייבדק ויאושר, תופנה לעמוד המנויים. ברגע שתבחר תוכנית (כולל התוכנית החינמית, אם זמינה) ותשלים את תהליך ההפעלה, הפרופיל שלך יהפוך באופן אוטומטי לפעיל וגלוי לקונים.",
      q2: "מה קורה אם הפרופיל שלי אינו מאושר?",
      a2: "אם הפרופיל שלך אינו מאושר, הוא לא יפורסם ב-SourceNest. תקבל את הסיבה לדחייה ותוכל לעדכן את המידע המבוקש לפני שתגיש אותו לבדיקה מחדש.",
      q3: "האם אני יכול לשדרג או להוריד תוכנית?",
      a3: "כן. אתה יכול לשנות את תוכנית המנוי שלך בכל עת מלוח הבקרה שלך. התוכנית החדשה שלך תיכנס לתוקף בהתאם למחזור החיוב שלך.",
      q4: "מה זה תוכנית יצרן המייסד?",
      a4: "תוכנית יצרן המייסד מעניקה ליצרנים נבחרים גישה ל-SourceNest עם 6 חודשים של גישה חינם. לאחר האישור, יצרנים זכאים יכולים להפעיל הצעה זו על ידי בחירת התוכנית החינמית.",
      q5: "מה קורה לאחר סיום תקופת ה-6 חודשים בחינם?",
      a5: "לפני שתקופת החינם שלך תפוג, אנו נודיע לך. כדי לשמור על הפרופיל שלך פעיל וגלוי לקונים, פשוט תבחר באחת מתוכניות המנוי בתשלום הזמינות.",
      q6: "האם תוכנית יצרן המייסד עדיין זמינה?",
      a6: "התוכנית זמינה רק למספר מוגבל של יצרנים. ברגע שכל המקומות הזמינים יתמלאו, ההצעה לא תהיה זמינה יותר.",
      q7: "האם יש עמלות עמלה על מכירות?",
      a7: "לא. SourceNest אינה גובה עמלה כלשהי על המכירות שלך. אתה משלם רק עבור תוכנית המנוי שלך.",
      q8: "אילו שיטות תשלום אתם מקבלים?",
      a8: "אנו מקבלים את כל כרטיסי האשראי והחיוב העיקריים, PayPal, וכל שיטת תשלום נוספת המוצגת בקופה.",
      q9: "מתי אני בוחר את תוכנית המנוי שלי?",
      a9: "תבחר את תוכנית המנוי שלך רק לאחר שפרופיל היצרן שלך ייבדק ויאושר. בשלב זה, תראה את כל התוכניות הזמינות ותוכל להפעיל את התוכנית המתאימה ביותר לעסק שלך.",
      q10: "האם אני יכול לבחור בתוכנית החינמית לאחר האישור?",
      a10: "כן. אם אתה זכאי, התוכנית החינמית תופיע יחד עם התוכניות בתשלום לאחר שפרופיל שלך יאושר. פשוט בחר בתוכנית שברצונך להפעיל.",
      q11: "מה קורה אם אני לא בוחר תוכנית לאחר האישור?",
      a11: "הפרופיל שלך יישאר מאושר, אך הוא לא יהפוך לגלוי לקונים עד שתפעיל תוכנית מנוי."
    },
    cta: {
      title: "מוכן להתחיל?",
  ...
  help: {
    ...
    searchResultsTitle: "תוצאות חיפוש",
    searchResultsCount: "נמצאו {count} מאמרים",
    searchNoResults: "החיפוש שלך לא נמצא",
    searchNoResultsHint:
      "לא מצאנו מאמרי עזרה התואמים לחיפוש שלך. אפשר לבקר בשאלות נפוצות או ליצור קשר עם התמיכה.",
    searchViewFaq: "צפה בשאלות נפוצות",
    searchContactSupport: "צור קשר עם התמיכה",
  ...
  mfg: {
      dashboard: {
        ...
        subtitle: "עקוב אחר ביצועי העסק שלך ופניות קונים.",
        profileComplete: "פרופיל מושלם ב-{percent}%",
        recentInquiries: "פניות אחרונות",
        viewAll: "צפה בהכל",
        noRecentInquiries: "אין פניות אחרונות.",
        responseMetrics: "מדדי תגובה",
        responseRate: "שיעור תגובה",
        quoteConversion: "המרת הצעות מחיר",
        ...
        na: "לא זמין",
        ratingReviews: "דירוג ממוצע ({count} חוות דעת)"
      },
      inquiries: {
        title: "פניות קונים",
        subtitle: "נהל והשב לבקשות קונים",
        ...
        rejected: "נדחה",
        expired: "פג תוקף",
        searchPlaceholder: "חפש לפי קונה, מוצר או מזהה פנייה...",
        ...
        message: "הודעה",
        sendQuote: "שלח הצעת מחיר",
        noInquiriesFound: "לא נמצאו פניות",
        adjustFilters: "נסה לשנות את המסננים שלך",
        newInquiriesAppear: "פניות קונים חדשות יופיעו כאן"
      },
      inquiryDetails: {
        title: "פרטי פנייה",
        backToInquiries: "חזרה לפניות",
        rfqNumber: "מספר RFQ",
        buyerProfile: "פרופיל קונה",
        viewCompany: "הצג חברה",
        productRequirements: "דרישות מוצר",
        quantity: "כמות",
        targetPrice: "מחיר יעד",
        deliveryDate: "תאריך משלוח נדרש",
        shippingTerms: "תנאי משלוח",
        destinationPort: "נמל/עיר יעד",
        paymentTerms: "תנאי תשלום",
        additionalNotes: "דרישות נוספות",
        attachment: "קובץ מצורף",
        quoteStatus: "סטטוס הצעת מחיר",
        yourQuote: "הצעת המחיר שלך",
        unitPrice: "מחיר יחידה",
        totalAmount: "סכום כולל",
        deliveryLeadTime: "זמן אספקה (ימים)",
        validityDate: "תוקף הצעת מחיר",
        paymentTermsQuote: "תנאי תשלום מוצעים",
        warrantyInfo: "מידע על אחריות",
        notes: "הערות/הסברים",
        sendQuoteButton: "שלח הצעת מחיר",
        updateQuoteButton: "עדכן הצעת מחיר",
        submitQuote: "שלח הצעת מחיר",
        cancelQuote: "בטל הצעת מחיר",
        inputUnitPrice: "הזן מחיר יחידה",
        inputDeliveryTime: "לדוגמה: 30",
        inputWarranty: "לדוגמה: אחריות לשנה אחת",
        inputNotes: "ספק פרטים על הצעת המחיר שלך...",
        successQuoteSent: "הצעת המחיר נשלחה בהצלחה"
      },
      messages: {
        title: "הודעות",
        selectChat: "בחר שיחה כדי להתחיל להתכתב",
        searchChats: "חפש שיחות...",
        noConversations: "לא נמצאו שיחות",
      ...
      supportTickets: {
        title: "קריאות שירות",
        subtitle: "צריך עזרה? שלח פנייה לצוות התמיכה שלנו.",
        createTicket: "פתח קריאת שירות",
        ticketSubject: "נושא",
        ticketDescription: "תיאור",
        ticketCategory: "קטגוריה",
        ticketPriority: "עדיפות",
        selectCategory: "בחר קטגוריה",
        selectPriority: "בחר עדיפות",
        submitTicket: "שלח קריאה",
        loadingTickets: "טוען קריאות שירות...",
        noTickets: "לא נמצאו קריאות שירות",
        ticketId: "מזהה קריאה",
        status: "סטטוס",
      ...
      supportTicketDetails: {
        ...
        backToTickets: "חזרה לקריאות שירות",
        ticketInfo: "מידע על הקריאה",
        created: "נוצר ב-",
        replies: "תגובות",
      ...
      reviewCenter: {
        title: "מרכז ביקורות",
        subtitle: "צפה והשב למשוב מקונים",
        averageRating: "דירוג ממוצע",
        totalReviews: "סה\"כ ביקורות",
        responseRate: "שיעור תגובה",
        ratingBreakdown: "פירוט דירוגים",
        reviews: "ביקורות",
        noReviews: "טרם התקבלו ביקורות.",
        reply: "השב",
        replied: "נענה",
      ...
      reviewSubmit: {
        title: "שלח תגובה",
        backToReviews: "חזרה לביקורות",
        writeResponse: "כתוב תגובה",
        responsePlaceholder: "הודה לקונה על המשוב או התייחס לחששות שלו...",
        submitResponse: "שלח תגובה",
        responseSuccess: "התגובה נשלחה בהצלחה"
      },
      orders: {
        title: "הזמנות",
        subtitle: "עקוב ונהל את ההזמנות והחוזים שלך",
      ...
      orderDetails: {
        ...
        estDelivery: "משלוח משוער",
        paymentTerms: "תנאי תשלום",
        shippingTerms: "תנאי שילוח",
        destination: "יעד",
        documents: "מסמכים",
        noDocuments: "אין מסמכים מצורפים.",
      ...
      orderNew: {
        ...
        subtitle: "הגדר הזמנה חדשה עבור לקוח והתחל לעקוב אחר התקדמותה.",
        selectBuyer: "בחר קונה",
        orderItems: "פריטי הזמנה",
        addItem: "הוסף מוצר",
        subtotal: "סכום ביניים",
        tax: "מע\"מ",
        totalAmount: "סכום כולל",
        placeOrder: "צור הזמנה",
        commercialTerms: "תנאים מסחריים",
        documentsNotes: "מסמכים והערות",
        attachDocuments: "צרף מסמכים",
        requiredFieldsError: "אנא מלא את כל שדות החובה המסומנים ב-*.",
        engagement: "עסקה",
        engagementTitle: "כותרת עסקה",
        engagementTitlePlaceholder: "לדוגמה: זהות מותג ועיצוב אריזה",
        orderTitle: "כותרת הזמנה",
        orderTitlePlaceholder: "לדוגמה: ספלים קרמיים פרימיום — 320 מ\"ל",
        scopePlaceholder: "לדוגמה: לוגו, 3 SKU אריזה, מדריך מותג",
        products: "מוצרים",
        productsHelp:
          "הוסף כל מוצר הכלול בהזמנה זו. כל שורה מתומחרת בנפרד ומסוכמת לסכום ההזמנה.",
        productLine: "מוצר {n}",
        ...
        lineTotal: "סכום שורה",
        notesPackaging: "הערות / פרטי אריזה",
        notesPackagingPlaceholder: "לדוגמה: הדפסת לוגו חד-צבעי, 24 יחידות בקרטון",
        selectProductFirst: "בחר מוצר תחילה",
        loadingBuyers: "טוען קונים...",
        chooseBuyer: "בחר קונה שעבדת איתו",
        noBuyers: "אין קונים זמינים",
        buyerHelp: "ניתן לבחור רק קונים שמחוברים דרך בקשות הצעת מחיר, הצעות מחיר או הודעות.",
        deliveryDate: "תאריך אספקה",
        timeline: "לוח זמנים",
        timelinePlaceholder: "לדוגמה: 3 שבועות",
        productionTimePlaceholder: "לדוגמה: 30 יום",
        paymentTermsPlaceholder: "לדוגמה: 50% מראש, 50% במסירה",
        shippingTermsPlaceholder: "לדוגמה: FOB Shanghai",
        destinationPlaceholder: "לדוגמה: לוס אנג'לס, ארה\"ב",
        notesPlaceholder: "הקשר נוסף על הזמנה זו...",
        productOrderError:
          "בחר קונה, הוסף כותרת הזמנה ותאריך אספקה, וודא שלכל שורת מוצר יש מוצר, כמות ומחיר ליחידה.",
        submitFailed: "יצירת ההזמנה נכשלה",
      },
      products: {
        title: "מוצרים",
        subtitle: "נהל את קטלוג המוצרים והרישומים שלך",
        addNewProduct: "הוסף מוצר חדש",
        searchProducts: "חפש מוצרים...",
        noProducts: "לא נמצאו מוצרים",
        createProductCTA: "הוסף את המוצר הראשון שלך",
        edit: "ערוך",
        delete: "מחק",
        ...
        inactive: "לא פעיל",
        actions: "פעולות",
        duplicateToDraft: "שכפל לטיוטה",
        setDraft: "הגדר כטיוטה",
        setActive: "הגדר כפעיל",
        setInactive: "הגדר כלא פעיל",
        editDialogDesc: "השינויים נשמרים ברישום הפעיל שלך.",
        minPrice: "מחיר מינימום",
        maxPrice: "מחיר מקסימום",
        moq: "כמות הזמנה מינימלית (MOQ)",
        leadTime: "זמן אספקה",
        categoryLabelPrefix: "קטגוריה:",
        categoryChangeDesc: "כדי לשנות קטגוריה, השתמש בעורך המוצר המלא כשהוא זמין.",
        deleteConfirmTitle: "למחוק מוצר?",
        viewDetailsTitle: "פרטי מוצר",
        viewDetailsDesc: "מידע מהרישום שלך.",
        views: "צפיות",
        adjustFilters: "נסה להתאים את המסננים או החיפוש.",
        page: "עמוד",
        of: "מתוך",
        totalLabel: "סה\"כ",
        newSubtitle: "מלא את הפרטים כדי לרשום את המוצר שלך",
        basicInfoDesc: "שם המוצר ותיאורו",
        subcategory: "תת-קטגוריה",
        imagesDesc: "העלה עד 10 תמונות באיכות גבוהה (חובה)",
        imagesRecommend: "מומלץ: 800x800 פיקסלים ומעלה. בפורמט JPG, PNG או WebP.",
        pricingQuantity: "תמחור וכמות",
        pricingDesc: "הגדר את טווח המחירים והזמנת המינימום שלך",
        priceMin: "מחיר מינימום",
        priceMax: "מחיר מקסימום",
        currency: "מטבע",
        supplyCapacity: "כושר אספקה",
        specificationsTitle: "מפרט מוצר",
        specificationsDesc: "הוסף מפרט מפורט",
        addSpecification: "הוסף מפרט",
        keyFeatures: "תכונות עיקריות",
        keyFeaturesDesc: "הדגש את נקודות המכירה העיקריות של המוצר שלך",
        addFeature: "הוסף תכונה",
        keyFeaturesLimit: "הוסף עד 10 תכונות עיקריות שיגרמו למוצר שלך לבלוט",
        customizationOptions: "אפשרויות התאמה אישית",
        customizationDesc: "מה קונים יכולים להתאים אישית עבור מוצר זה?",
        addOption: "הוסף אפשרות",
        customizationCommon: "אפשרויות נפוצות: הדפסת לוגו, צבע מותאם אישית, אריזה מותאמת אישית, מיתוג OEM",
        shippingPackaging: "משלוח ואריזה",
        shippingPackagingDesc: "לוגיסטיקה ופרטי אריזה",
        packagingType: "סוג אריזה",
        portOfLoading: "נמל טעינה",
        packageDimensions: "מידות אריזה",
        packageWeight: "משקל אריזה",
        packagingCost: "עלות אריזה ליחידה",
        unitsPerCarton: "יחידות בקרטון",
        packagingDesc: "תיאור אריזה",
        shippingMethods: "שיטות משלוח",
        additionalOptions: "אפשרויות נוספות",
        additionalOptionsDesc: "דוגמיות, התאמה אישית ומילות מפתח",
        samplesAvailable: "דוגמיות זמינות",
        samplesDesc: "קונים יכולים לבקש דוגמיות מוצר",
        samplePrice: "מחיר דוגמית",
        customizationAvailable: "התאמה אישית זמינה",
        customizationAvailableDesc: "שירותי OEM/ODM עבור מוצר זה",
        customizationDetails: "פרטי התאמה אישית",
        keywords: "מילות מפתח של המוצר",
        keywordsDesc: "הפרד מילות מפתח בפסיקים. אלה עוזרים לקונים למצוא את המוצר שלך.",
        brochure: "עלון מוצר (PDF)",
        saveAsDraft: "שמור כטיוטה",
        publishProduct: "פרסם מוצר",
        selectCategoryError: "אנא בחר קטגוריה.",
        selectSubcategoryError: "אנא בחר תת-קטגוריה.",
        selectCurrencyError: "אנא בחר מטבע.",
        addImageError: "הוסף לפחות תמונת מוצר אחת.",
        enterNameError: "אנא הזן שם מוצר.",
        enterDescError: "אנא הזן תיאור מוצר.",
        enterMinPriceError: "אנא הזן מחיר מינימום תקין.",
        enterMaxPriceError: "אנא הזן מחיר מקסימום תקין.",
        enterMoqError: "אנא הזן כמות הזמנה מינימלית (MOQ).",
        enterLeadTimeError: "אנא הזן זמן אספקה.",
        createFailed: "יצירת המוצר נכשלה",
        loadError: "לא ניתן לטעון את המוצר.",
        loadCategoriesError: "לא ניתן לטעון קטגוריות.",
        loadingProduct: "טוען מוצר…",
        loadingCategories: "טוען קטגוריות…",
        noCategories: "אין קטגוריות זמינות",
        selectCategoryFirst: "בחר קטגוריה תחילה",
        noSubcategories: "אין תת-קטגוריות",
        selectSubcategory: "בחר תת-קטגוריה",
        supplyPeriodDay: "ליום",
        supplyPeriodWeek: "לשבוע",
        supplyPeriodMonth: "לחודש",
        noShippingMethods: "לא הוחזרו שיטות משלוח.",
        uploadPdf: "העלה PDF",
        updateFailed: "עדכון המוצר נכשל",
        savedStatus: "נשמר",
        addMore: "הוסף עוד",
        shippingMethodsDesc: "נטען מה-API. בחר לפחות אחת אם הרישום שלך דורש אפשרויות משלוח.",
        publishing: "מפרסם…",
        brochureDesc: "עלון PDF אופציונלי לקונים."
      },
      productForm: {
        createTitle: "הוסף מוצר חדש",
        editTitle: "ערוך מוצר",
        ...
        selectCategory: "בחר קטגוריה",
        description: "תיאור",
        pricingSpecs: "תמחור ומפרטים",
        minOrderQty: "כמות הזמנה מינימלית",
        unit: "יחידה (לדוגמה: יחידות, ק\"ג)",
        priceRange: "טווח מחירים",
        fobPort: "נמל FOB (אופציונלי)",
        deliveryTime: "זמן אספקה מוערך (ימים)",
        images: "תמונות מוצר",
        uploadImages: "העלה תמונות",
        maxImages: "מקסימום 5 תמונות",
        save: "שמור מוצר",
        saving: "שומר...",
        successCreate: "המוצר נוצר בהצלחה",
        successUpdate: "המוצר עודכן בהצלחה"
      },
      catalogs: {
        title: "קטלוגי מוצרים",
        subtitle: "העלה ונהל את קטלוגי ה-PDF שלך להורדה על ידי קונים",
        uploadCatalog: "העלה קטלוג",
        catalogName: "שם קטלוג",
        selectFile: "בחר קובץ PDF",
        noCatalogs: "טרם הועלו קטלוגים.",
        uploadSuccess: "הקטלוג הועלה בהצלחה",
        deleteConfirm: "האם אתה בטוח שברצונך למחוק קטלוג זה?"
      },
      certifications: {
        title: "אישורים ותעודות",
        subtitle: "נהל את אישורי החברה ומסמכי הציות שלך",
        addCertification: "הוסף אישור",
        certName: "שם האישור",
        issuingBody: "גוף מנפיק",
        expiryDate: "תאריך תפוגה",
        uploadCertificate: "העלה קובץ אישור",
        noCertifications: "טרם נוספו אישורים.",
        addSuccess: "האישור נוסף בהצלחה",
        deleteConfirm: "האם אתה בטוח שברצונך למחוק אישור זה?",
        loading: "טוען אישורים...",
        validCount: "אישורים בתוקף",
        ...
        update: "עדכן",
        delete: "מחק",
        addFirst: "הוסף את האישור הראשון שלך",
        showing: "מציג {from}–{to} מתוך {total}",
        previous: "הקודם",
        next: "הבא",
        pageOf: "עמוד {page} מתוך {lastPage}",
        deleted: "נמחק",
        deleteSuccess: "האישור נמחק בהצלחה",
        loadError: "טעינת האישורים נכשלה",
        deleteError: "מחיקת האישור נכשלה",
        certificateFallback: "אישור #{id}",
        deleteTitle: "למחוק אישור?",
        deleteDesc: "לא ניתן לבטל פעולה זו."
      },
      markets: {
        title: "שווקי ייצוא",
        subtitle: "הגדר את אזורי ומדינות הייצוא המטרה שלך",
        saveMarkets: "שמור שווקים",
        successUpdate: "שווקי הייצוא עודכנו בהצלחה",
        addNewMarket: "הוסף שוק חדש",
        activeMarkets: "שווקים פעילים",
        totalInquiries: "סה\"כ פניות",
        orders: "הזמנות",
        growthRate: "שיעור צמיחה",
        activeRegions: "אזורי ייצוא פעילים",
        activeRegionsDesc: "שווקים שבהם אתה מקבל פניות כרגע",
        noCountriesSelected: "לא נבחרו מדינות",
        inquiries: "פניות",
        manage: "נהל",
        noActiveRegions: "לא הוגדרו אזורי ייצוא פעילים. לחץ \"הוסף שוק חדש\" כדי להתחיל.",
        suggestedMarkets: "שווקים מומלצים",
        suggestedMarketsDesc: "אזורים מומלצים בהתבסס על קטגוריות המוצרים שלך",
        searchCountries: "חפש מדינות...",
        selectRegion: "בחר אזור",
        loadError: "טעינת נתוני שווקי הייצוא נכשלה",
        noChanges: "אין שינויים לשמירה.",
        saveFailed: "שמירת חלק משינויי שווקי הייצוא נכשלה.",
        updateFailed: "עדכון שווקי הייצוא נכשל",
        selectRegionError: "אנא בחר אזור.",
        addRegionFailed: "הוספה/עדכון האזור נכשל",
        removeRegionFailed: "הסרת האזור נכשלה",
        saving: "שומר..."
      },
      analytics: {
        title: "אנליטיקה",
        subtitle: "עקוב אחר הביצועים ומעורבות הקונים שלך",
        profileViews: "צפיות בפרופיל",
        inquiriesReceived: "פניות שהתקבלו",
        responseTime: "זמן תגובה ממוצע",
        topProducts: "מוצרים מובילים לפי צפיות",
        ...
        performanceDesc: "עקוב אחר צפיות בפרופיל, פניות והודעות לאורך זמן",
        conversionFunnel: "משפך המרה",
        conversionFunnelDesc: "ראה כיצד קונים עוברים מצפייה לפנייה",
        topProductsTitle: "מוצרים מובילים",
        topProductsDesc: "מוצרים עם הכי הרבה צפיות ופניות",
        views: "צפיות",
        inquiries: "פניות",
        messages: "הודעות",
        quoteRequests: "בקשות הצעת מחיר",
        buyerCountries: "מדינות קונים",
        buyerCountriesDesc: "היכן נמצאים הקונים שלך",
        other: "אחר"
      },
      profile: {
        title: "פרופיל חברה",
        subtitle: "נהל כיצד החברה שלך מופיעה לקונים פוטנציאליים",
        ...
        successUpdate: "הפרופיל עודכן בהצלחה",
        basicInfo: "מידע בסיסי",
        ...
        successTitle: "הצלחה!",
        mainProducts: "מוצרים עיקריים",
        mainProductsPlaceholder: "רשום את המוצרים העיקריים שלך, מופרדים בפסיקים",
        saving: "שומר..."
      },
      subscription: {
        title: "ניהול מנוי",
        subtitle: "נהל את מסלול המנוי שלך, מחזור החיוב ומגבלות השימוש",
        currentPlan: "מסלול נוכחי",
        planDetails: "פרטי מסלול",
        ...
        inquiriesLimit: "מגבלת פניות",
        productsLimit: "מגבלת מוצרים",
        messagesLimit: "מגבלת הודעות",
        planChangesApproval: "שינויי תוכנית ואישור",
        planChangesDesc: "שדרוגים נכנסים לתוקף מיידית לאחר התשלום. שנמוכים יחולו בתום תקופת החיוב הנוכחית. כל השינויים כפופים לבדיקת מנהל מערכת.",
        cancelSubscription: "ביטול מנוי",
        cancellationScheduled: "מתוזמן לביטול",
        cancellationScheduledDesc: "המנוי שלך מוגדר לביטול ב-{date}. תישאר לך גישה עד אז.",
        cancelSubscriptionDesc: "בטל את המנוי שלך. תישמר לך גישה עד לסוף תקופת החיוב הנוכחית.",
        popular: "פופולרי",
        current: "מסלול נוכחי",
        availablePlans: "תוכניות זמינות",
        saveDiscount: "חסוך 17%",
        contactSales: "צור קשר עם המכירות",
        active: "פעיל",
        canceling: "מבטל",
        noSubscription: "אין מנוי",
        activatingSubscription: "מפעיל את המנוי שלך...",
      ...
      loginHistory: {
        ...
        subtitle: "עקוב אחר התחברויות ומכשירים אחרונים",
        ipAddress: "כתובת IP",
        device: "מכשיר/דפדפן",
        location: "מיקום",
        timestamp: "חותמת זמן"
