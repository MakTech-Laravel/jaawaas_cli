...
const ar: TranslationKeys = {
  ...
  landing: {
    ...
    howItWorks: {
      ...
      mfgStep2Desc: "اشترك في خطتك المختارة بدفع آمن. يتم إنشاء حسابك ولكنه يتطلب المراجعة والموافقة قبل أن يتم تفعيله.",
      ...
      mfgStep5Desc: "بمجرد أن يصبح جاهزاً، أرسل ملفك الشخصي ليقوم فريقنا بمراجعته. نقوم بتقييم معلوماتك للحفاظ على جودة المنصة.",
