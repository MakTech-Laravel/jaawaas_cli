...
const ar = {
  ...
  nav: {
    ...
    statusSuspended: "تم تعليق الحساب",
    statusNeedsMoreInfo: "مطلوب مزيد من المعلومات",
    descPendingApproval: "حسابك قيد المراجعة حاليًا.",
    descRejected: "يرجى الاتصال بالدعم.",
    descSuspended: "يرجى الاتصال بالدعم.",
    descNeedsMoreInfo: "يرجى التحقق من رسائلك.",
    requiredBadge: "مطلوب",
    loading: "جارٍ التحميل...",
    ...
    adminReviewManagement: "إدارة المراجعات",
    adminHelpCenter: "مركز المساعدة",
  ...
  settings: {
    ...
    twoFactorEnabledDesc: "مفعّل. استخدم تطبيق المصادقة أثناء تسجيل الدخول.",
    twoFactorDisabledDesc: "أضف طبقة أمان إضافية إلى حسابك.",
    twoFactorViewRecoveryCodes: "عرض رموز الاسترداد",
    twoFactorRegenerateCodes: "إعادة إنشاء الرموز",
    twoFactorEnableTitle: "تمكين المصادقة الثنائية",
    twoFactorEnableDesc: "أدخل كلمة مرور حسابك لبدء إعداد المصادقة الثنائية.",
    twoFactorStartSetup: "بدء الإعداد",
    twoFactorScanAndVerify: "مسح وتحقق",
    twoFactorManualKey: "المفتاح اليدوي:",
    twoFactorVerificationCode: "رمز التحقق",
    twoFactorConfirmAndEnable: "تأكيد وتمكين",
    twoFactorDisableTitle: "تعطيل المصادقة الثنائية",
    twoFactorDisableBtn: "تعطيل",
    twoFactorRegenerateBtn: "إعادة إنشاء",
    twoFactorDisableDesc: "أدخل كلمة المرور الخاصة بك لإزالة حماية المصادقة الثنائية.",
    twoFactorRecoveryCodesTitle: "رموز الاسترداد",
    twoFactorCopyCodes: "نسخ الرموز",
    twoFactorDone: "تم",
    twoFactorRegenerateTitle: "إعادة إنشاء رموز الاسترداد",
    twoFactorRegenerateDesc: "ستتوقف رموز الاسترداد الحالية عن العمل فوراً.",
    twoFactorPasswordRequired: "كلمة المرور مطلوبة",
    twoFactorPasswordRequiredEnableDesc: "يرجى إدخال كلمة المرور لتمكين المصادقة الثنائية.",
    twoFactorPasswordRequiredDisableDesc: "يرجى إدخال كلمة المرور لتعطيل المصادقة الثنائية.",
    twoFactorPasswordRequiredRegenDesc: "يرجى إدخال كلمة المرور لإعادة إنشاء رموز الاسترداد.",
    twoFactorCodeRequired: "الرمز مطلوب",
    twoFactorCodeRequiredDesc: "أدخل رمز التحقق من تطبيق المصادقة الخاص بك.",
    twoFactorSetupError: "تعذر بدء إعداد المصادقة الثنائية",
    twoFactorVerifyError: "تعذر التحقق من الرمز",
    twoFactorDisableError: "تعذر تعطيل المصادقة الثنائية",
    twoFactorLoadCodesError: "تعذر تحميل رموز الاسترداد",
    twoFactorRegenerateError: "تعذر إعادة إنشاء الرموز",
    twoFactorEnabledToast: "تم تمكين المصادقة الثنائية",
    twoFactorEnabledToastDesc: "احفظ رموز الاسترداد الخاصة بك في مكان آمن.",
    twoFactorDisabledToast: "تم تعطيل المصادقة الثنائية",
    twoFactorDisabledToastDesc: "يستخدم حسابك الآن تسجيل الدخول بكلمة المرور فقط.",
    twoFactorRegeneratedToast: "تم إعادة إنشاء رموز الاسترداد",
    twoFactorRegeneratedToastDesc: "رموز الاسترداد القديمة لم تعد صالحة.",
    twoFactorCopiedToast: "تم النسخ",
    twoFactorCopiedToastDesc: "تم نسخ رموز الاسترداد إلى الحافظة.",
    twoFactorCopyFailedToast: "فشل النسخ",
    twoFactorCopyFailedToastDesc: "يرجى نسخ رموز الاسترداد يدوياً.",
    twoFactorStarting: "جاري البدء...",
    twoFactorVerifying: "جاري التحقق...",
    twoFactorDisabling: "جاري التعطيل...",
    twoFactorRegenerating: "جاري إعادة الإنشاء...",
    twoFactorNoRecoveryCodes: "لا تتوفر رموز استرداد بعد.",
    twoFactorDefaultSetupMessage: "امسح رمز الاستجابة السريعة (QR) هذا باستخدام تطبيق المصادقة الخاص بك وأدخل الرمز المكون من 6 أرقام.",
    twoFactorDefaultRecoveryMessage: "احتفظ برموز النسخ الاحتياطي هذه في مكان آمن. يمكن استخدام كل رمز مرة واحدة فقط.",
    ...
    backupQueuedSuccess: "تمت جدولة النسخة الاحتياطية بنجاح.",
    failedToQueueBackup: "فشل جدولة النسخة الاحتياطية.",
    failedToLoadTables: "فشل تحميل الجداول.",
    selectAtLeastOneTable: "اختر جدولاً واحداً على الأقل للتصدير.",
    exportQueuedSuccess: "تمت جدولة التصدير بنجاح.",
    failedToQueueExport: "فشل جدولة التصدير.",
    downloadFailed: "فشل التنزيل.",
    noBackupsYet: "لا توجد نسخ احتياطية بعد",
    recentExports: "عمليات التصدير الأخيرة",
    exportFullDatabase: "قاعدة البيانات كاملة",
    exportSelectTables: "اختر الجداول",
    noTablesAvailable: "لا توجد جداول متاحة.",
    subscription: "الاشتراك",
    ...
    deactivateDesc: "تعطيل حسابك مؤقتًا. يمكنك إعادة تفعيله لاحقًا باستخدام كلمة المرور الخاصة بك.",
    reactivateAccount: "إعادة تفعيل الحساب",
    reactivateDesc: "إذا قمت بالتعطيل سابقًا، فأدخل كلمة المرور الخاصة بك لإعادة تشغيل حسابك.",
    deleteDesc: "طلب حذف دائم. قد تحتاج إلى التأكيد عبر البريد الإلكتروني أو رمز OTP بعد ذلك.",
    startedDeletionMistake: "هل بدأت الحذف عن طريق الخطأ؟",
    restoreAccount: "استعادة الحساب",
    confirmDeactivation: "تأكيد التعطيل",
    confirmPassword: "أدخل كلمة المرور للتأكيد. سيتم تسجيل خروجك حتى تقوم بالتفعيل مرة أخرى.",
    deactivating: "جاري التعطيل...",
    reactivating: "جاري إعادة التفعيل...",
    submitting: "جاري التقديم...",
    submitDeletionRequest: "تقديم طلب الحذف",
    deleteRequestDesc: "هذا يبدأ عملية الحذف على الخادم. لا يمكن التراجع عن هذا الإجراء من هنا بمجرد اكتماله.",
    reasonOptional: "السبب (اختياري)",
    reasonRequired: "السبب",
    passwordLabel: "كلمة المرور",
    reasonPlaceholder: "أخبرنا لماذا تغادر (اختياري ولكنه مفيد)",
    enterPasswordToRestore: "أدخل كلمة المرور الحالية لاستعادة الوصول الكامل.",
    deactivateBtn: "تعطيل",
  ...
  landing: {
    ...
    suppliersMap: {
      ...
      searchRegionsTitle: "المناطق المطابقة",
      searchCountriesTitle: "الدول المطابقة",
      searchNoResults: "لم يتم العثور على بحثك",
      searchNoResultsHint: "لم نتمكن من العثور على أي دول أو مناطق تطابق بحثك. جرب مصطلحًا مختلفًا أو زر الأسئلة الشائعة أو اتصل بالدعم.",
      searchViewFaq: "عرض الأسئلة الشائعة",
      searchContactSupport: "اتصل بالدعم",
    },
    whyUse: {
  ...
  pricing: {
    ...
    faq: {
      ...
      a1: "نعم. بعد مراجعة ملف المصنع الخاص بك والموافقة عليه، سيتم إعادة توجيهك إلى صفحة الاشتراك. بمجرد اختيار خطة (بما في ذلك الخطة المجانية، إذا كانت متاحة) وإكمال عملية التفعيل، سيصبح ملفك التعريفي نشطًا ومرئيًا للمشترين تلقائيًا.",
      q2: "ماذا يحدث إذا لم تتم الموافقة على ملفي؟",
      a2: "إذا لم تتم الموافقة على ملفك الشخصي، فلن يتم نشره على SourceNest. ستتلقى سبب الرفض ويمكنك تحديث المعلومات المطلوبة قبل إرسالها للمراجعة مرة أخرى.",
      q3: "هل يمكنني الترقية أو الخفض إلى خطة أخرى؟",
      a3: "نعم. يمكنك تغيير خطة الاشتراك الخاصة بك في أي وقت من لوحة التحكم. ستدخل خطتك الجديدة دخل التنفيذ وفقًا لدورة الفوترة الخاصة بك.",
      q4: "ما هو برنامج المصنع المؤسس؟",
      a4: "يمنح برنامج المصنع المؤسس مصنعين محددين وصولاً إلى SourceNest مع 6 أشهر من الوصول المجاني. بعد الموافقة، يمكن للمصنعين المؤهلين تفعيل هذا العرض عن طريق اختيار الخطة المجانية.",
      q5: "ماذا يحدث بعد انتهاء فترة الـ 6 أشهر المجانية؟",
      a5: "قبل انتهاء فترتك المجانية، سنقوم بإخطارك. للحفاظ على ملفك الشخصي نشطًا ومرئيًا للمشترين، ستختار ببساطة إحدى خطط الاشتراك المدفوعة المتاحة.",
      q6: "هل برنامج المصنع المؤسس لا يزال متاحًا؟",
      a6: "البرنامج متاح فقط لعدد محدود من المصنعين. بمجرد ملء جميع الأماكن المتاحة، لن يكون العرض متاحًا بعد الآن.",
      q7: "هل هناك رسوم عمولة على المبيعات؟",
      a7: "لا. لا تفرض SourceNest أي عمولة على مبيعاتك. أنت تدفع فقط مقابل خطة الاشتراك الخاصة بك.",
      q8: "ما طرق الدفع التي تقبلونها؟",
      a8: "نحن نقبل جميع بطاقات الائتمان والخصم الرئيسية، وPayPal، وأي طرق دفع إضافية معروضة عند الدفع.",
      q9: "متى أختار خطة الاشتراك الخاصة بي؟",
      a9: "ستختار خطة الاشتراك الخاصة بك فقط بعد مراجعة ملف المصنع الخاص بك والموافقة عليه. في تلك المرحلة، ستتمكن من رؤية جميع الخطط المتاحة وتفعيل الخطة التي تناسب عملك.",
      q10: "هل يمكنني اختيار الخطة المجانية بعد الموافقة؟",
      a10: "نعم. إذا كنت مؤهلاً، فستظهر الخطة المجانية جنباً إلى جنب مع الخطط المدفوعة بعد الموافقة على ملفك التعريفي. ببساطة اختر الخطة التي تريد تفعيلها.",
      q11: "ماذا يحدث إذا لم أختر خطة بعد الموافقة؟",
      a11: "سيبقى ملفك الشخصي معتمدًا، ولكنه لن يكون مرئيًا للمشترين حتى تقوم بتفعيل خطة الاشتراك."
    },
    cta: {
    ...
    authGate: {
      guestTitle: "يلزم حساب مُصنِّع",
      guestDescription: "التسعير والاشتراكات مخصصة للمصنعين فقط. سجّل الدخول إلى حساب المصنّع الخاص بك، أو أنشئ حسابًا للمتابعة.",
      wrongRoleTitle: "انتقل إلى حساب مُصنِّع",
      wrongRoleDescription: "أنت مسجّل الدخول بحساب ليس حساب مُصنِّع. أنشئ حساب مُصنِّع للاشتراك، أو تواصل مع الدعم إذا كنت بحاجة إلى مساعدة.",
      signIn: "تسجيل الدخول",
      createManufacturer: "إنشاء حساب مُصنِّع",
  ...
  help: {
    ...
    searchResultsTitle: "نتائج البحث",
    searchResultsCount: "تم العثور على {count} مقالات",
    searchNoResults: "لم يتم العثور على بحثك",
    searchNoResultsHint:
      "لم نتمكن من العثور على أي مقالات مساعدة تطابق بحثك. يمكنك زيارة الأسئلة الشائعة أو الاتصال بالدعم.",
    searchViewFaq: "عرض الأسئلة الشائعة",
    searchContactSupport: "اتصل بالدعم",
  ...
  mfg: {
      dashboard: {
        ...
        subtitle: "مراقبة أداء عملك واستفسارات المشترين.",
        profileComplete: "الملف الشخصي مكتمل بنسبة {percent}%",
        recentInquiries: "الاستفسارات الأخيرة",
        viewAll: "عرض الكل",
        noRecentInquiries: "لا توجد استفسارات أخيرة.",
        responseMetrics: "مقاييس الاستجابة",
        responseRate: "معدل الاستجابة",
        quoteConversion: "تحويل العروض",
        onTimeDelivery: "التسليم في الوقت المحدد",
        quickStats: "إحصائيات سريعة",
        activeProducts: "المنتجات النشطة",
        pendingQuotes: "العروض المعلقة",
        unreadMessages: "رسائل غير مقروءة",
        avgResponseTime: "متوسط وقت الاستجابة",
        recentActivity: "النشاط الأخير",
        noRecentActivity: "لا يوجد نشاط أخير.",
        na: "غير متوفر",
        ratingReviews: "متوسط التقييم ({count} تقييم)"
      },
      inquiries: {
        title: "استفسارات المشترين",
        subtitle: "إدارة والرد على طلبات المشترين",
        ...
        searchPlaceholder: "البحث حسب المشتري، المنتج، أو رقم الاستفسار...",
        allStatus: "جميع الحالات",
        loading: "جاري تحميل الاستفسارات...",
        destinationCountry: "بلد الوجهة",
        targetPrice: "السعر المستهدف",
        deliveryBy: "التسليم بحلول",
        terms: "الشروط",
        port: "الميناء",
        ...
        newInquiriesAppear: "ستظهر استفسارات المشترين الجديدة هنا"
      },
      inquiryDetails: {
        title: "تفاصيل الاستفسار",
        backToInquiries: "العودة إلى الاستفسارات",
        ...
        destinationPort: "ميناء/مدينة الوجهة",
        paymentTerms: "شروط الدفع",
        additionalNotes: "متطلبات إضافية",
        attachment: "المرفق",
        quoteStatus: "حالة عرض السعر",
        yourQuote: "عرض السعر الخاص بك",
        unitPrice: "سعر الوحدة",
        totalAmount: "المبلغ الإجمالي",
        deliveryLeadTime: "مهلة التسليم (أيام)",
        validityDate: "تاريخ صلاحية العرض",
        paymentTermsQuote: "شروط الدفع المقترحة",
        warrantyInfo: "معلومات الضمان",
        notes: "ملاحظات/تنبيهات",
        sendQuoteButton: "إرسال عرض السعر",
        updateQuoteButton: "تحديث عرض السعر",
        submitQuote: "تقديم عرض السعر",
        cancelQuote: "إلغاء عرض السعر",
        inputUnitPrice: "أدخل سعر الوحدة",
        inputDeliveryTime: "مثال: 30",
        inputWarranty: "مثال: ضمان لمدة سنة",
        inputNotes: "قدم تفاصيل حول عرض السعر الخاص بك...",
        successQuoteSent: "تم إرسال عرض السعر بنجاح"
      },
      messages: {
        title: "الرسائل",
      ...
      supportTickets: {
        ...
        subtitle: "هل تحتاج إلى مساعدة？ أرسل تذكرة إلى فريق الدعم لدينا.",
      ...
      reviewCenter: {
        ...
        subtitle: "عرض والرد على تقييمات وملاحظات المشترين",
        averageRating: "متوسط التقييم",
        totalReviews: "إجمالي التقييمات",
        responseRate: "معدل الاستجابة",
        ratingBreakdown: "تفصيل التقييمات",
        reviews: "التقييمات",
        noReviews: "لم يتم استلام أي تقييمات بعد.",
        reply: "رد",
        replied: "تم الرد",
        yourResponse: "ردك",
        date: "التاريخ"
      ...
      reviewSubmit: {
        title: "تقديم الرد",
        backToReviews: "العودة إلى التقييمات",
        writeResponse: "اكتب ردك",
        responsePlaceholder: "اشكر المشتري على تقييمه أو عالج أي مخاوف لديه...",
        submitResponse: "إرسال الرد",
        responseSuccess: "تم تقديم الرد بنجاح"
      },
      orders: {
        title: "الطلبات",
        subtitle: "تتبع وإدارة طلباتك وعقودك",
      ...
      products: {
        title: "المنتجات",
        subtitle: "إدارة كتالوج المنتجات وقائمتك",
        addNewProduct: "إضافة منتج جديد",
        searchProducts: "البحث في المنتجات...",
        noProducts: "لم يتم العثور على منتجات",
        createProductCTA: "أضف منتجك الأول",
        edit: "تعديل",
        delete: "حذف",
        ...
        inactive: "غير نشط",
        actions: "إجراءات",
        duplicateToDraft: "تكرار كمسودة",
        setDraft: "تعيين كمسودة",
        setActive: "تعيين كنشط",
        setInactive: "تعيين كغير نشط",
        editDialogDesc: "يتم حفظ التغييرات في قائمتك المباشرة.",
        minPrice: "أقل سعر",
        maxPrice: "أعلى سعر",
        moq: "الحد الأدنى للطلب",
        leadTime: "وقت التسليم",
        categoryLabelPrefix: "الفئة:",
        categoryChangeDesc: "لتغيير الفئة، استخدم محرر المنتج الكامل عند توفره.",
        deleteConfirmTitle: "حذف المنتج؟",
        viewDetailsTitle: "تفاصيل المنتج",
        viewDetailsDesc: "معلومات من قائمتك.",
        views: "المشاهدات",
        adjustFilters: "حاول ضبط التصفية أو البحث.",
        page: "صفحة",
        of: "من",
        totalLabel: "إجمالي",
        newSubtitle: "املأ التفاصيل لإدراج منتجك",
        basicInfoDesc: "اسم المنتج والوصف",
        subcategory: "الفئة الفرعية",
        imagesDesc: "تحميل ما يصل إلى 10 صور عالية الجودة (مطلوب)",
        imagesRecommend: "موصى به: 800x800 بكسل أو أكبر. بتنسيق JPG أو PNG أو WebP.",
        pricingQuantity: "الأسعار والكمية",
        pricingDesc: "حدد نطاق السعر والحد الأدنى للطلب",
        priceMin: "أقل سعر",
        priceMax: "أعلى سعر",
        currency: "العملة",
        supplyCapacity: "قدرة التوريد",
        specificationsTitle: "مواصفات المنتج",
        specificationsDesc: "إضافة تفاصيل المواصفات",
        addSpecification: "إضافة مواصفة",
        keyFeatures: "الميزات الرئيسية",
        keyFeaturesDesc: "سلط الضوء على نقاط البيع الرئيسية لمنتجك",
        addFeature: "إضافة ميزة",
        keyFeaturesLimit: "أضف ما يصل إلى 10 ميزات رئيسية تجعل منتجك متميزًا",
        customizationOptions: "خيارات التخصيص",
        customizationDesc: "ما الذي يمكن للمشترين تخصيصه لهذا المنتج؟",
        addOption: "إضافة خيار",
        customizationCommon: "الخيارات الشائعة: طباعة الشعار، لون مخصص، تغليف مخصص، علامة تجارية OEM",
        shippingPackaging: "الشحن والتعبئة",
        shippingPackagingDesc: "الخدمات اللوجستية وتفاصيل التعبئة والتغليف",
        packagingType: "نوع التعبئة والتغليف",
        portOfLoading: "ميناء التحميل",
        packageDimensions: "أبعاد العبوة",
        packageWeight: "وزن العبوة",
        packagingCost: "تكلفة التعبئة لكل وحدة",
        unitsPerCarton: "الوحدات لكل كرتونة",
        packagingDesc: "وصف التعبئة والتغليف",
        shippingMethods: "طرق الشحن",
        additionalOptions: "خيارات إضافية",
        additionalOptionsDesc: "العينات، التخصيص، والكلمات المفتاحية",
        samplesAvailable: "العينات متوفرة",
        samplesDesc: "يمكن للمشترين طلب عينات من المنتج",
        samplePrice: "سعر العينة",
        customizationAvailable: "التخصيص متاح",
        customizationAvailableDesc: "خدمات OEM/ODM لهذا المنتج",
        customizationDetails: "تفاصيل التخصيص",
        keywords: "الكلمات المفتاحية للمنتج",
        keywordsDesc: "افصل الكلمات المفتاحية بفاصلة. تساعد هذه المشترين في العثور على منتجك.",
        brochure: "كتيب المنتج (PDF)",
        saveAsDraft: "حفظ كمسودة",
        publishProduct: "نشر المنتج",
        selectCategoryError: "يرجى اختيار فئة.",
        selectSubcategoryError: "يرجى اختيار فئة فرعية.",
        selectCurrencyError: "يرجى اختيار عملة.",
        addImageError: "يرجى إضافة صورة منتج واحدة على الأقل.",
        enterNameError: "يرجى إدخال اسم المنتج.",
        enterDescError: "يرجى إدخال وصف المنتج.",
        enterMinPriceError: "يرجى إدخال سعر أدنى صالح.",
        enterMaxPriceError: "يرجى إدخال سعر أقصى صالح.",
        enterMoqError: "يرجى إدخال الحد الأدنى لكمية الطلب (MOQ).",
        enterLeadTimeError: "يرجى إدخال وقت التسليم.",
        createFailed: "فشل إنشاء المنتج",
        loadError: "تعذر تحميل المنتج.",
        loadCategoriesError: "تعذر تحميل الفئات.",
        ...
        supplyPeriodDay: "يومياً",
        supplyPeriodWeek: "أسبوعياً",
        supplyPeriodMonth: "شهرياً",
        noShippingMethods: "لم يتم إرجاع طرق شحن.",
        uploadPdf: "تحميل PDF",
        updateFailed: "فشل تحديث المنتج",
        savedStatus: "محفوظ",
        addMore: "إضافة المزيد",
        shippingMethodsDesc: "يتم تحميلها من واجهة برمجة التطبيقات. اختر واحدة على الأقل إذا كان إدراجك يتطلب خيارات شحن.",
        publishing: "جاري النشر…",
        brochureDesc: "كتيب PDF اختياري للمشترين."
      },
      productForm: {
        ...
        selectCategory: "اختر الفئة",
        description: "الوصف",
        pricingSpecs: "الأسعار والمواصفات",
        minOrderQty: "الحد الأدنى لكمية الطلب",
        unit: "الوحدة (مثل قطعة، كجم)",
        priceRange: "نطاق السعر",
        fobPort: "ميناء FOB (اختياري)",
        deliveryTime: "وقت التسليم المقدر (أيام)",
        images: "صور المنتج",
      ...
      catalogs: {
        ...
        subtitle: "تحميل وإدارة كتالوجات PDF ليقوم المشترون بتنزيلها",
        ...
        deleteConfirm: "هل أنت متأكد أنك تريد حذف هذا الكتالوج؟"
      },
      certifications: {
        title: "الشهادات",
        subtitle: "إدارة شهادات شركتك ومستندات الامتثال",
        addCertification: "إضافة شهادة",
        certName: "اسم الشهادة",
        issuingBody: "الجهة المصدرة",
        expiryDate: "تاريخ الانتهاء",
        uploadCertificate: "تحميل ملف الشهادة",
        noCertifications: "لم يتم إضافة أي شهادات بعد.",
        addSuccess: "تم إضافة الشهادة بنجاح",
        deleteConfirm: "هل أنت متأكد أنك تريد حذف هذه الشهادة؟",
        loading: "جاري تحميل الشهادات...",
        validCount: "الشهادات السارية",
        ...
        update: "تحديث",
        delete: "حذف",
        addFirst: "أضف شهادتك الأولى",
        showing: "عرض {from}–{to} من {total}",
        previous: "السابق",
        next: "التالي",
        pageOf: "صفحة {page} من {lastPage}",
        deleted: "تم الحذف",
        deleteSuccess: "تم حذف الشهادة بنجاح",
        loadError: "فشل تحميل الشهادات",
        deleteError: "فشل حذف الشهادة",
        certificateFallback: "شهادة #{id}",
        deleteTitle: "حذف الشهادة؟",
        deleteDesc: "لا يمكن التراجع عن هذا الإجراء."
      },
      markets: {
        title: "أسواق التصدير",
        subtitle: "حدد مناطق وبلدان التصدير المستهدفة",
        saveMarkets: "حفظ الأسواق",
        successUpdate: "تم تحديث أسواق التصدير بنجاح",
        addNewMarket: "إضافة سوق جديد",
        activeMarkets: "الأسواق النشطة",
        totalInquiries: "إجمالي الاستفسارات",
        orders: "الطلبات",
        growthRate: "معدل النمو",
        activeRegions: "مناطق التصدير النشطة",
        activeRegionsDesc: "الأسواق التي تتلقى فيها استفسارات حالياً",
        noCountriesSelected: "لم يتم اختيار أي بلدان",
        inquiries: "الاستفسارات",
        manage: "إدارة",
        noActiveRegions: "لم يتم تحديد مناطق تصدير نشطة. انقر \"إضافة سوق جديد\" للبدء.",
        suggestedMarkets: "أسواق مقترحة",
        suggestedMarketsDesc: "مناطق موصى بها بناءً على فئات منتجاتك",
        searchCountries: "البحث في البلدان...",
        selectRegion: "اختر منطقة",
        loadError: "فشل تحميل بيانات أسواق التصدير",
        noChanges: "لا توجد تغييرات للحفظ.",
        saveFailed: "فشل حفظ بعض تعديلات أسواق التصدير.",
        updateFailed: "فشل تحديث أسواق التصدير",
        selectRegionError: "يرجى اختيار منطقة.",
        addRegionFailed: "فشل إضافة/تحديث المنطقة",
        removeRegionFailed: "فشل إزالة المنطقة",
        saving: "جاري الحفظ..."
      },
      analytics: {
        title: "التحليلات",
        subtitle: "تتبع أدائك وتفاعل المشترين",
        profileViews: "مشاهدات الملف الشخصي",
        inquiriesReceived: "الاستفسارات المستلمة",
        responseTime: "متوسط وقت الاستجابة",
        topProducts: "أعلى المنتجات مشاهدة",
        ...
        performanceDesc: "تتبع مشاهدات الملف الشخصي والاستفسارات والرسائل بمرور الوقت",
        conversionFunnel: "قمع التحويل",
        conversionFunnelDesc: "شاهد كيف ينتقل المشترون من المشاهدة إلى الاستفسار",
        topProductsTitle: "أفضل المنتجات",
        topProductsDesc: "المنتجات ذات أكبر عدد من المشاهدات والاستفسارات",
        views: "المشاهدات",
        inquiries: "الاستفسارات",
        messages: "الرسائل",
        quoteRequests: "طلبات عروض الأسعار",
        buyerCountries: "بلدان المشترين",
        buyerCountriesDesc: "أماكن تواجد مشترينك",
        other: "أخرى"
      },
      profile: {
        title: "ملف الشركة",
        subtitle: "إدارة كيفية ظهور شركتك للمشترين المحتملين",
        ...
        mainProductsPlaceholder: "اذكر منتجاتك الرئيسية، مفصولة بفواصل",
        saving: "جاري الحفظ..."
      },
      subscription: {
        title: "إدارة الاشتراك",
        subtitle: "إدارة خطة الاشتراك، دورة الفوترة، وحدود الاستخدام",
        currentPlan: "الخطة الحالية",
        ...
        inquiriesLimit: "حد الاستفسارات",
        productsLimit: "حد المنتجات",
        messagesLimit: "حد الرسائل",
        planChangesApproval: "تغييرات الخطة والموافقة",
        planChangesDesc: "تدخل الترقيات حيز التنفيذ فورًا بعد الدفع. تنطبق التخفيضات في نهاية فترة الفوترة الحالية. تخضع جميع التغييرات لمراجعة المسؤول.",
        cancelSubscription: "إلغاء الاشتراك",
        cancellationScheduled: "جدولة الإلغاء",
        cancellationScheduledDesc: "تم تعيين اشتراكك للإلغاء في {date}. ستحتفظ بحق الوصول حتى ذلك الوقت.",
        cancelSubscriptionDesc: "إلغاء اشتراكك. ستحتفظ بحق الوصول حتى نهاية فترة الفوترة الحالية.",
        popular: "شائع",
        ...
        activatingSubscription: "جاري تفعيل اشتراكك...",
      ...
      loginHistory: {
        ...
        subtitle: "مراقبة جلسات تسجيل الدخول والأجهزة الأخيرة",
        ipAddress: "عنوان IP",
