...
export default function AdminLayout({
  ...
  const navigation = [
    ...
    { name: (t?.nav as any)?.adminOrders || "Orders", href: "/admin/orders", icon: ShoppingBag },
    { name: t?.nav?.adminMessages || "Messages", href: "/admin/messages", icon: MessageSquare },
    { name: (t?.nav as any)?.adminSupportTickets || "Support Tickets", href: "/admin/customer-supports/tickets", icon: HelpCircle },
